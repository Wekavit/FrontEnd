  ...
  return (
    <div className="w-full flex flex-wrap h-89vh mt-11vh sm:h-auto md:h-auto overflow-hidden">
      ...
      <div className="w-1/2 pl-17 h-full flex flex-col justify-center mt-8 sm:w-full md:w-full sm:h-auto md:h-auto md:py-8 md:px-20 sm:p-5">
        ...
        <p className="text-gray-text text-1.2rem font-normal sm:font-normal leading-relaxed mb-6 sm:leading-relaxed sm:text-sm">
          Epargnez et investissez votre argent en toute simplicité en commençant
          par aussi peu que 500 franc. Gagnez des intérêts de 9 à 11 %.
        </p>
