...
const Hands = () => {
  return (
    <div className=" w-full h-auto px-17 flex bg-white py-9 sm:flex-col sm:px-4 sm:justify-center sm:items-center md:flex-col md:items-center md:justify-center md:px-20">
      <div className="w-3/6 h-auto flex justify-center items-center py-5 mt-5 sm:w-full sm:py-0 md:w-90% md:py-3">
      ...
      <div className="w-3/6 h-auto flex justify-center items-center py-5 mt-5 sm:w-full sm:mt-9 md:w-full md:mt-2">
