...
export const Hero = () => {
  return <div className="w-full flex flex-wrap h-89vh mt-11vh">
    ...
    <div className="w-1/2 pl-17 h-full flex flex-col justify-center mt-8"> 
      <p className="text-5rem font-black tracking-wide leading-tight text-hero-text mb-6"><span className="text-primary-color">Wekavit, </span>epargnez juducieusement votre <br />argent</p>
      <p className="text-gray-text text-1.2rem font-medium -ml-1 leading-relaxed mb-4 tracking-wide">Wekavit vous aide à atteindre vos objectifs financiers en vous <br /> permettant d'épargner et d'investir facilement</p>
