...
const Burger = ({ open, setOpen }) => {
  return (
    <>
      ...
      {/* Menu */}
      <div
        className={`hidden sm:flex md:flex md:px-17 overflow-y-scroll overflow-x-hidden fixed h-extra bg-hero-color py-5 px-6 w-full top-20 left-0 z-30 transition-all ease-in-out delay-150 ${
